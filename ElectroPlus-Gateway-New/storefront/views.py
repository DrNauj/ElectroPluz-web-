...
def get_chatbot_response(message):
    ...
    responses = {
        # Saludos
        'hola': '¡Hola! Soy el asistente virtual de LibreCel. ¿En qué puedo ayudarte hoy?',
        'buenos dias': '¡Buenos días! ¿Cómo puedo ayudarte con tu compra en LibreCel?',
        ...
        'email': 'Nuestro correo de atención al cliente es: soporte@librecel.com.pe',
        ...
        'adios': '¡Hasta luego! Gracias por elegir LibreCel. ¡Que tengas un excelente día!',
    ...
    if any(word in message for word in ['como', 'donde', 'cuando', 'que', 'cual']):
        return 'Para obtener información más específica, te recomiendo contactar directamente con nuestro equipo de atención al cliente al 01-123-4567 o por email a soporte@librecel.com.pe'
